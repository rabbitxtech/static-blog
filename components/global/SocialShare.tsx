...
const SocialShare = () => {
	...
	return (
		<div className="relative">
			...
			{isShare && (
				<div className="absolute flex p-2 rounded top-10 left-[50%] translate-x-[-50%] dark:bg-gray-200 before:w-4 before:h-4 before:absolute before:top-[-8px] before:left-[50%] before:translate-x-[-50%] before:rotate-45 dark:before:bg-gray-200">
					<a
